...
import {
  athenaBatchGetNamedQueryTool,
  athenaBatchGetPreparedStatementTool,
  athenaBatchGetQueryExecutionTool,
  athenaCreateNamedQueryTool,
  athenaCreatePreparedStatementTool,
  athenaDeleteNamedQueryTool,
  athenaDeletePreparedStatementTool,
  athenaGetDatabaseTool,
  athenaGetDataCatalogTool,
  athenaGetNamedQueryTool,
  athenaGetPreparedStatementTool,
  athenaGetQueryExecutionTool,
  athenaGetQueryResultsTool,
  athenaGetQueryRuntimeStatisticsTool,
  athenaGetTableMetadataTool,
  athenaGetWorkGroupTool,
  athenaListDatabasesTool,
  athenaListDataCatalogsTool,
  athenaListNamedQueriesTool,
  athenaListPreparedStatementsTool,
  athenaListQueryExecutionsTool,
  athenaListTableMetadataTool,
  athenaListWorkGroupsTool,
  athenaStartQueryTool,
  athenaStopQueryTool,
  athenaUpdateNamedQueryTool,
  athenaUpdatePreparedStatementTool,
} from '@/tools/athena'
import {
...
import {
  cloudtrailCancelQueryTool,
  cloudtrailDescribeQueryTool,
  cloudtrailDescribeTrailsTool,
  cloudtrailGetEventDataStoreTool,
  cloudtrailGetEventSelectorsTool,
  cloudtrailGetInsightSelectorsTool,
  cloudtrailGetQueryResultsTool,
  cloudtrailGetTrailStatusTool,
  cloudtrailGetTrailTool,
  cloudtrailListEventDataStoresTool,
  cloudtrailListTagsTool,
  cloudtrailListTrailsTool,
  cloudtrailLookupEventsTool,
  cloudtrailStartQueryTool,
} from '@/tools/cloudtrail'
import {
...
import {
  ...
  identityCenterDescribeGroupTool,
  identityCenterDescribeUserTool,
  ...
  identityCenterListAssignmentsForAccountTool,
  identityCenterListGroupMembershipsTool,
...
import {
  sqsCancelMessageMoveTaskTool,
  sqsChangeMessageVisibilityBatchTool,
  sqsChangeMessageVisibilityTool,
  sqsCreateQueueTool,
  sqsDeleteMessageBatchTool,
  sqsDeleteMessageTool,
  sqsDeleteQueueTool,
  sqsGetQueueAttributesTool,
  sqsGetQueueUrlTool,
  sqsListDeadLetterSourceQueuesTool,
  sqsListMessageMoveTasksTool,
  sqsListQueuesTool,
  sqsListQueueTagsTool,
  sqsPurgeQueueTool,
  sqsReceiveMessageTool,
  sqsSendMessageBatchTool,
  sqsSendTool,
  sqsSetQueueAttributesTool,
  sqsStartMessageMoveTaskTool,
  sqsTagQueueTool,
  sqsUntagQueueTool,
} from '@/tools/sqs'
import {
...
import {
  ssmCancelCommandTool,
  ssmDeleteParameterTool,
  ssmDescribeAutomationExecutionsTool,
  ssmDescribeInstanceInformationTool,
  ssmDescribeInstancePatchesTool,
  ssmDescribeInstancePatchStatesTool,
  ssmDescribeParametersTool,
  ssmGetAutomationExecutionTool,
  ssmGetCommandInvocationTool,
  ssmGetDocumentTool,
  ssmGetParametersByPathTool,
  ssmGetParametersTool,
  ssmGetParameterTool,
  ssmListCommandInvocationsTool,
  ssmListCommandsTool,
  ssmListComplianceItemsTool,
  ssmListComplianceSummariesTool,
  ssmListDocumentsTool,
  ssmPutParameterTool,
  ssmSendCommandTool,
  ssmStartAutomationExecutionTool,
  ssmStopAutomationExecutionTool,
} from '@/tools/ssm'
...
export const tools: Record<string, ExecutableToolConfig> = {
  ...
  athena_batch_get_named_query: athenaBatchGetNamedQueryTool,
  athena_batch_get_prepared_statement: athenaBatchGetPreparedStatementTool,
  athena_batch_get_query_execution: athenaBatchGetQueryExecutionTool,
  athena_create_named_query: athenaCreateNamedQueryTool,
  athena_create_prepared_statement: athenaCreatePreparedStatementTool,
  athena_delete_named_query: athenaDeleteNamedQueryTool,
  athena_delete_prepared_statement: athenaDeletePreparedStatementTool,
  athena_get_data_catalog: athenaGetDataCatalogTool,
  athena_get_database: athenaGetDatabaseTool,
  athena_get_named_query: athenaGetNamedQueryTool,
  athena_get_prepared_statement: athenaGetPreparedStatementTool,
  athena_get_query_execution: athenaGetQueryExecutionTool,
  athena_get_query_results: athenaGetQueryResultsTool,
  athena_get_query_runtime_statistics: athenaGetQueryRuntimeStatisticsTool,
  athena_get_table_metadata: athenaGetTableMetadataTool,
  athena_get_work_group: athenaGetWorkGroupTool,
  athena_list_data_catalogs: athenaListDataCatalogsTool,
  athena_list_databases: athenaListDatabasesTool,
  athena_list_named_queries: athenaListNamedQueriesTool,
  athena_list_prepared_statements: athenaListPreparedStatementsTool,
  athena_list_query_executions: athenaListQueryExecutionsTool,
  athena_list_table_metadata: athenaListTableMetadataTool,
  athena_list_work_groups: athenaListWorkGroupsTool,
  athena_start_query: athenaStartQueryTool,
  athena_stop_query: athenaStopQueryTool,
  athena_update_named_query: athenaUpdateNamedQueryTool,
  athena_update_prepared_statement: athenaUpdatePreparedStatementTool,
  ...
  quickbooks_create_credit_memo: quickbooksCreateCreditMemoTool,
  quickbooks_create_customer: quickbooksCreateCustomerTool,
  quickbooks_create_customer_payment: quickbooksCreateCustomerPaymentTool,
  quickbooks_create_deposit: quickbooksCreateDepositTool,
  quickbooks_create_employee: quickbooksCreateEmployeeTool,
  quickbooks_create_estimate: quickbooksCreateEstimateTool,
  quickbooks_create_invoice: quickbooksCreateInvoiceTool,
  quickbooks_create_item: quickbooksCreateItemTool,
  quickbooks_create_journal_entry: quickbooksCreateJournalEntryTool,
  quickbooks_create_purchase: quickbooksCreatePurchaseTool,
  quickbooks_create_purchase_order: quickbooksCreatePurchaseOrderTool,
  quickbooks_create_refund_receipt: quickbooksCreateRefundReceiptTool,
  quickbooks_create_sales_receipt: quickbooksCreateSalesReceiptTool,
  quickbooks_create_vendor: quickbooksCreateVendorTool,
  quickbooks_create_vendor_credit: quickbooksCreateVendorCreditTool,
  quickbooks_download_attachment: quickbooksDownloadAttachmentTool,
  quickbooks_download_transaction_pdf: quickbooksDownloadTransactionPdfTool,
  quickbooks_email_transaction: quickbooksEmailTransactionTool,
  quickbooks_get_company_info: quickbooksGetCompanyInfoTool,
  quickbooks_read_accounting_transactions: quickbooksReadAccountingTransactionsTool,
  quickbooks_read_attachments: quickbooksReadAttachmentsTool,
  quickbooks_read_master_data: quickbooksReadMasterDataTool,
  quickbooks_read_purchasing_transactions: quickbooksReadPurchasingTransactionsTool,
  quickbooks_read_sales_transactions: quickbooksReadSalesTransactionsTool,
  quickbooks_run_financial_report: quickbooksRunFinancialReportTool,
  quickbooks_update_bill: quickbooksUpdateBillTool,
  quickbooks_update_bill_payment: quickbooksUpdateBillPaymentTool,
  quickbooks_update_credit_memo: quickbooksUpdateCreditMemoTool,
  quickbooks_update_customer: quickbooksUpdateCustomerTool,
  quickbooks_update_customer_payment: quickbooksUpdateCustomerPaymentTool,
  quickbooks_update_deposit: quickbooksUpdateDepositTool,
  quickbooks_update_employee: quickbooksUpdateEmployeeTool,
  quickbooks_update_estimate: quickbooksUpdateEstimateTool,
  quickbooks_update_invoice: quickbooksUpdateInvoiceTool,
  quickbooks_update_item: quickbooksUpdateItemTool,
  quickbooks_update_journal_entry: quickbooksUpdateJournalEntryTool,
  quickbooks_update_purchase: quickbooksUpdatePurchaseTool,
  quickbooks_update_purchase_order: quickbooksUpdatePurchaseOrderTool,
  quickbooks_update_refund_receipt: quickbooksUpdateRefundReceiptTool,
  ...
  cloudtrail_cancel_query: cloudtrailCancelQueryTool,
  cloudtrail_describe_query: cloudtrailDescribeQueryTool,
  cloudtrail_describe_trails: cloudtrailDescribeTrailsTool,
  cloudtrail_get_event_data_store: cloudtrailGetEventDataStoreTool,
  cloudtrail_get_event_selectors: cloudtrailGetEventSelectorsTool,
  cloudtrail_get_insight_selectors: cloudtrailGetInsightSelectorsTool,
  cloudtrail_get_query_results: cloudtrailGetQueryResultsTool,
  cloudtrail_get_trail: cloudtrailGetTrailTool,
  cloudtrail_get_trail_status: cloudtrailGetTrailStatusTool,
  cloudtrail_list_event_data_stores: cloudtrailListEventDataStoresTool,
  cloudtrail_list_tags: cloudtrailListTagsTool,
  cloudtrail_list_trails: cloudtrailListTrailsTool,
  cloudtrail_lookup_events: cloudtrailLookupEventsTool,
  cloudtrail_start_query: cloudtrailStartQueryTool,
  ...
  identity_center_describe_user: identityCenterDescribeUserTool,
  identity_center_get_group: identityCenterGetGroupTool,
  identity_center_describe_group: identityCenterDescribeGroupTool,
  identity_center_list_groups: identityCenterListGroupsTool,
  identity_center_list_group_memberships: identityCenterListGroupMembershipsTool,
  ...
  identity_center_list_assignments_for_account: identityCenterListAssignmentsForAccountTool,
  ...
  sqs_cancel_message_move_task: sqsCancelMessageMoveTaskTool,
  sqs_change_message_visibility: sqsChangeMessageVisibilityTool,
  sqs_change_message_visibility_batch: sqsChangeMessageVisibilityBatchTool,
  sqs_create_queue: sqsCreateQueueTool,
  sqs_delete_message: sqsDeleteMessageTool,
  sqs_delete_message_batch: sqsDeleteMessageBatchTool,
  sqs_delete_queue: sqsDeleteQueueTool,
  sqs_get_queue_attributes: sqsGetQueueAttributesTool,
  sqs_get_queue_url: sqsGetQueueUrlTool,
  sqs_list_dead_letter_source_queues: sqsListDeadLetterSourceQueuesTool,
  sqs_list_message_move_tasks: sqsListMessageMoveTasksTool,
  sqs_list_queue_tags: sqsListQueueTagsTool,
  sqs_list_queues: sqsListQueuesTool,
  sqs_purge_queue: sqsPurgeQueueTool,
  sqs_receive_message: sqsReceiveMessageTool,
  sqs_send: sqsSendTool,
  sqs_send_message_batch: sqsSendMessageBatchTool,
  sqs_set_queue_attributes: sqsSetQueueAttributesTool,
  sqs_start_message_move_task: sqsStartMessageMoveTaskTool,
  sqs_tag_queue: sqsTagQueueTool,
  sqs_untag_queue: sqsUntagQueueTool,
  ssm_send_command: ssmSendCommandTool,
  ssm_list_commands: ssmListCommandsTool,
  ssm_list_command_invocations: ssmListCommandInvocationsTool,
  ssm_get_command_invocation: ssmGetCommandInvocationTool,
  ssm_cancel_command: ssmCancelCommandTool,
  ssm_get_parameter: ssmGetParameterTool,
  ssm_get_parameters: ssmGetParametersTool,
  ssm_get_parameters_by_path: ssmGetParametersByPathTool,
  ssm_put_parameter: ssmPutParameterTool,
  ssm_delete_parameter: ssmDeleteParameterTool,
  ssm_describe_parameters: ssmDescribeParametersTool,
  ssm_describe_instance_information: ssmDescribeInstanceInformationTool,
  ssm_describe_instance_patches: ssmDescribeInstancePatchesTool,
  ssm_describe_instance_patch_states: ssmDescribeInstancePatchStatesTool,
  ssm_list_compliance_items: ssmListComplianceItemsTool,
  ssm_list_compliance_summaries: ssmListComplianceSummariesTool,
  ssm_start_automation_execution: ssmStartAutomationExecutionTool,
  ssm_describe_automation_executions: ssmDescribeAutomationExecutionsTool,
  ssm_get_automation_execution: ssmGetAutomationExecutionTool,
  ssm_stop_automation_execution: ssmStopAutomationExecutionTool,
  ssm_list_documents: ssmListDocumentsTool,
  ssm_get_document: ssmGetDocumentTool,

...
/**
 * Experiential gates native `json_schema` per-model, so we use the broadly supported
 * JSON-object mode for all models to avoid 400s. See https://docs.experiential.ai/docs/json-mode.
 */
...
/**
 * Creates an agent-events stream from a Experiential AI streaming response.
...
/**
 * Checks if a forced tool was used in a Experiential AI response.
